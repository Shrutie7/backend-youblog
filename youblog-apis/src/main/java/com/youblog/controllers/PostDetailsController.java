...
public class PostDetailsController {
	...
	public ResponseEntity<Map<String, Object>> postUpdate(
			@RequestBody UpdatePostDetailsRequest updatePostDetailsRequest) {
	...
	public ResponseEntity<Map<String, Object>> postRemoveBookmark(
			@RequestBody PostBookmarkRequest postBookmarkRequest) {
	...
	public ResponseEntity<Map<String, Object>> postCommentAdd(
	...
	public ResponseEntity<Map<String, Object>> postCommentEdit(
	...
	public ResponseEntity<Map<String, Object>> postCommentList(
			@RequestBody PostCommentListRequest postCommentListRequest) {
	...
	public ResponseEntity<Map<String, Object>> postCommentReplyList(
			@RequestBody PostCommentReplyListRequest postCommentReplyListRequest) {
		return postDetailsService.postCommentReplyList(postCommentReplyListRequest);
	}

	@PostMapping("/comment/reply")
	public ResponseEntity<Map<String, Object>> postCommentReply(
			@RequestBody PostCommentReplyRequest postCommentReplyRequest) {
	...
	public ResponseEntity<Map<String, Object>> postCommentDelete(
			@RequestBody PostCommentReplyListRequest postCommentDeleteRequest) {
		return postDetailsService.postCommentDelete(postCommentDeleteRequest);
	}

	@PostMapping("/list/user/based")
	public ResponseEntity<Map<String, Object>> postListBasedOnUser(
			@RequestBody PostDetailsListRequest postDetailsListRequest) {
